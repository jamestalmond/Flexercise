...
const PROJECT_NAME = 'flexercise'; // Change project name to your project name
const PROJECT_SERVER_PATH = '//media.ao.com/uk/qa/flexercise/'; // Change project server path to your project path
...
gulp.task('dev', ['templates', 'scss', 'scripts', 'images'], function() {
	const apiProxy = proxy(['/ProductsHandler.axd', '/Themes', '/l/', '/product/'], {
		target: 'http://ao.com',
...
gulp.task('scss', function() {
	...
	scssStream = scssStream.pipe(sass({ includePaths: [`${AO_FEA_GLOBALS_PATH}sass`, `${AO_FEA_GLOBALS_PATH}modules`, 'node_modules'] })
